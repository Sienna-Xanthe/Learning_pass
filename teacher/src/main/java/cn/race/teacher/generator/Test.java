package cn.race.teacher.generator;
...
//                            .enableSwagger() // 开启 swagger 模式
                            ...
                            .outputDir("C://Users//win10//Desktop//Learning_pass//teacher//src//main//java"); // 指定输出目录
                })
                .packageConfig(builder -> {
                    builder.parent("cn.race") // 设置父包名
                            .moduleName("teacher") // 设置父包模块名mapperXml
                            .entity("pojo")
                            .pathInfo(Collections.singletonMap(OutputFile.mapper, "C://Users//win10//Desktop//Learning_pass//teacher//src//main//java//cn//race//teacher//mapper"))
                .pathInfo(Collections.singletonMap(OutputFile.xml,"C://Users//win10//Desktop//Learning_pass//teacher//src//main//resources//mapper"));
